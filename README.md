...
Currently, the toolbox implements two algorithms based on Dynamic Mode Decomposition ( [Tu et al. 2014](#references) ), and one algorithm based on Discrete Fourier Transform. All functions have similar syntax.
